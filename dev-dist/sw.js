...
define(['./workbox-137dedbd'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^\/storage\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^\/s3\/.*/i, new workbox.CacheFirst({
    "cacheName": "s3-cache",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 500,
      maxAgeSeconds: 2592000

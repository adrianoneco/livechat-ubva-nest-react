...
export class WhatsappInstance {
  ...
  @Column({ name: 'instance_name', type: 'varchar', length: 255, unique: true })
  instanceName: string;

  @Column({ type: 'varchar', length: 50, default: 'disconnected', nullable: true })
  status: string;
  ...
  @Column({ name: 'provider_type', type: 'varchar', default: 'self_hosted' })
  providerType: string;

  @Column({ name: 'instance_id_external', type: 'varchar', nullable: true })
